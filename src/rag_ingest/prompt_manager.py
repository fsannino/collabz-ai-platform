...
class PromptManager:
    _STYLES = {
        "normal": (
            ...
            "Comece pela resposta direta e desenvolva os pontos solicitados "
            "na medida permitida pelas fontes."
        ),
        "executiva": (
...
10. Se as fontes forem totalmente insuficientes ou conflitantes, responda exatamente: "Não encontrei evidência documental suficiente para responder com segurança."
...
17. Para perguntas amplas, cubra todos os aspectos pedidos e organize a resposta com poucos subtítulos informativos.
...
22. Não omita um aspecto solicitado apenas para manter a resposta curta; trate cada aspecto sustentado pelas fontes.
23. {instruction}
24. {depth_instruction}
